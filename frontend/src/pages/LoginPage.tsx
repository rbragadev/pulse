        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-2xl shadow-black/40">
          ...
          <div className="flex items-center justify-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">by OTG</p>
            </div>
          </div>
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-muted-foreground">
              Plataforma interna de reconhecimento OTG
            </p>
          </div>

          <button
            onClick={handleGoogleLogin}
            className="w-full flex items-center justify-center gap-3 bg-primary hover:bg-primary/90 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-200 hover:shadow-lg hover:shadow-primary/25 active:scale-[0.98]"
          >
          ...
          <div className="mt-6 pt-6 border-t border-border">
            <p className="text-center text-xs text-muted-foreground">
              Apenas e-mails{' '}
              <span className="text-foreground/70 font-medium">@grupootg.com</span> são permitidos
            </p>
          </div>
        </div>
      </div>
